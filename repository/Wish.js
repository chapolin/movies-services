(function() {
  ...
  WishRepository.prototype.insert = function(movie, callback) {
  ...
  WishRepository.prototype.checkIfMovieExists = function(userId, movieId, callback) {
  ...
  WishRepository.prototype.deleteByMovieId = function(userId, movieId, callback) {
    var collection = global.mongo.collection(this.getCollection()), self = this,
